...
class Breakout:
    ...
    def collision(self):
        ...
        for ball in self.balls:
            ...
            # if ball.getCollisionCoords(self.item) is not None:
            #     # 当たったらballを増やす
    ...
    def createObjects(self):
        ...
        # アイテムを作成
        self.item = Item(
            (NUM_H_BLOCK*WIDTH_BLOCK)//2,
            NUM_V_BLOCK*HEIGHT_BLOCK,
            WIDTH_BLOCK,
            HEIGHT_BLOCK)
    ...
    def drawFigures(self):
        ...
        # アイテムを描画
        x1, y1, x2, y2 = self.item.getCoords()
